package com.videocutter.video_compressor.compressor
...
import com.videocutter.video_compressor.CompressionProgressListener
import com.videocutter.video_compressor.config.Configuration
import com.videocutter.video_compressor.utils.CompressorUtils.findTrack
import com.videocutter.video_compressor.utils.CompressorUtils.generateWidthAndHeight
import com.videocutter.video_compressor.utils.CompressorUtils.getBitrate
import com.videocutter.video_compressor.utils.CompressorUtils.hasQTI
import com.videocutter.video_compressor.utils.CompressorUtils.prepareVideoHeight
import com.videocutter.video_compressor.utils.CompressorUtils.prepareVideoWidth
import com.videocutter.video_compressor.utils.CompressorUtils.printException
import com.videocutter.video_compressor.utils.CompressorUtils.setOutputFileParameters
import com.videocutter.video_compressor.utils.CompressorUtils.setUpMP4Movie
import com.videocutter.video_compressor.utils.StreamableVideo
import com.videocutter.video_compressor.video.InputSurface
import com.videocutter.video_compressor.video.MP4Builder
import com.videocutter.video_compressor.video.OutputSurface
import com.videocutter.video_compressor.video.Result
                            ...
                            if (index == videoIndex) {
                                ...
                                if (inputBufferIndex >= 0) {
                                    val inputBuffer = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                                        ...
                                        decoder.inputBuffers[inputBufferIndex]
                                    }
