package com.videocutter.videodub_addsound.common;
...
//                return new GlLookUpTableFilter(bitmap);
            ...
            case WATERMARK:
                return null;
//        new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(), R.drawable.sample_bitmap), GlWatermarkFilter.Position.RIGHT_BOTTOM);
            case WEAK_PIXEL:
            ...
            case BITMAP_OVERLAY_SAMPLE:
                return null;
//        GlBitmapOverlaySample(BitmapFactory.decodeResource(context.getResources(), R.drawable.sample_bitmap));
            default:
                return new GlFilter();
        }
    }
